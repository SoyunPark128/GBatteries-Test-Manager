...
namespace GBatteriesTestManager.Views
{
    ...
    public sealed partial class ExtendedSplash : Page
    {
        ...
        MainViewModel VIewModel => App.ViewModel;
        ...
        {
            await Task.Run(VIewModel.GetBatteryListAsync);
            await Task.Run(VIewModel.GetTestListAsync);
            await Task.Run(() => VIewModel.GetTestData());
